namespace GeneralUtils
{
    ...
    public sealed class TimerAsync : IDisposable
    {
        ...
        public TimerAsync(Func<CancellationToken, Task> scheduledAction, TimeSpan period, bool canStartNextActionBeforePreviousIsCompleted = false) : this(scheduledAction, TimeSpan.Zero, period, canStartNextActionBeforePreviousIsCompleted)
        {
        }
